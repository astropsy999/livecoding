...
<head>
  ...
  <!-- Favicons -->
  <link href="<?=ROOT?>/assets/images/logo.png" rel="icon">
  <link href="<?=ROOT?>/assets/images/logo.png" rel="apple-touch-icon">
                  ...
                  <form method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Введіть свій email</div>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Пам'ятати мене</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Логін</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Немає облікового запису? <a href="<?=ROOT?>/signup">Створити аккаунт</a></p>
                    </div>
                  </form>
